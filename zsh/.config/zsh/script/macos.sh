...
# Arduino stuff
alias arduino-cli="${HOME}/.local/share/nvim/lsp_servers/arduino_language_server/arduino-cli/arduino-cli"
alias ino="${HOME}/.local/share/nvim/lsp_servers/arduino_language_server/arduino-cli/arduino-cli"
alias ino-upload-uno="${HOME}/.local/share/nvim/lsp_servers/arduino_language_server/arduino-cli/arduino-cli compile --fqbn arduino:avr:uno --upload --port /dev/cu.usbmodem1411401 ./"
